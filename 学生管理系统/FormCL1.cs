...
namespace 学生管理系统
{
    public partial class FormCL1 : Form
    {
        public Form9 fm;
        public FormCL1()
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand MyCommand = new SqlCommand("select Sname,CLname,Hname from CL,S where CL.CLnum=S.CLnum AND S.Snum=@ID;", conn); //定义一个数据库操作指令
            ...
            {
                DataRow row = table.Rows[0];    //遍历每一行,得到每一行的内容
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand MyCommand = new SqlCommand("select CLname,Hname from CL;", conn); //定义一个数据库操作指令
