...
namespace 学生管理系统
{
    public partial class FormC4 : Form
    {
        public Form9 fm;
        public FormC4()
        {
        ...
        public FormC4(Form9 tfm)
        {
            ...
            SqlCommand MyCommand = new SqlCommand("select Cname from C;", conn); //定义一个数据库操作指令
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                conn.Open();
                SqlCommand cmd = new SqlCommand("delete from C where Cname=@Cname", conn);
                ...
                {
                    MessageBox.Show("删除失败！课程不存在 或 此课程有学生选修！");
