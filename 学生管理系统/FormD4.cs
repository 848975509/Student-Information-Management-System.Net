...
namespace 学生管理系统
{
    public partial class FormD4 : Form
    {
        public Form9 fm;
        public FormD4()
        {
        ...
        public FormD4(Form9 tfm)
        {
            ...
            SqlCommand MyCommand = new SqlCommand("select Dname from D;", conn); //定义一个数据库操作指令
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                conn.Open();
                SqlCommand cmd = new SqlCommand("delete from D where Dname=@Dname", conn);
                cmd.Parameters.AddWithValue("@Dname", comboBox1.Text);
                ...
                {
                    MessageBox.Show("删除失败！专业不存在 或 此专业有学生选！");
